    ...
    <div class="team-area section-padding30">
        <div class="container">
            ...
            <div class="container" style="background-color: #f8f9fa; padding: 20px; border-radius: 8px;">
                <form action="<?php echo e(route('appointments.store')); ?>" method="POST" role="form" enctype="multipart/form-data" style="font-size: 18px;">
                    <?php echo csrf_field(); ?>
                    <div class="row">
...
<?php echo $__env->make('master.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Project-Web-App-main\resources\views/create-appointment.blade.php ENDPATH**/ ?>