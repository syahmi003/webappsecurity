        ...
        <div class="container">
            ...
            <div class="billing-content">
                <table class="table" style="font-size: 18px;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="<?php echo e($invoice->payment_status === 'PAID' ? 'status-paid' : 'status-unpaid'); ?>">
                                    <?php echo e($invoice->payment_status); ?>

                                </span>
                            </td>
                            <td>
                                <a href="<?php echo e(route('invoice.show', $invoice->id)); ?>" class="text-info" title="View Invoice">👁</a>
                                <a href="<?php echo e(route('invoice.edit', $invoice->id)); ?>" class="text-info" title="Edit Invoice">✏</a>
                                <a href="#" class="text-danger delete-invoice" data-id="<?php echo e($invoice->id); ?>" title="Delete Invoice">🗑</a>
                ...
                <div class="button-container text-right">
                    <a href="<?php echo e(route('create-invoice')); ?>" class="btn btn-primary">Add new billing</a>
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('master.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Project-Web-App-main\resources\views/billing-list.blade.php ENDPATH**/ ?>