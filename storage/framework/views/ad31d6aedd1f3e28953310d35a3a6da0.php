...
<head>
    ...
    <title> Group A - Web App Project </title>
                            ...
                            <div class="main-menu f-right d-none d-lg-block">
                                <nav>
                                    <ul id="navigation">
                                        ...
                                        <li><a href="<?php echo e(route('patients.index')); ?>">Patient</a></li>
                                        <li><a href="<?php echo e(route('appointments.index')); ?>">Appointment</a></li>
                                        <li class="nav-item dropdown">
                                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                                Billing
                                            </a>
                                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                                <li><a class="dropdown-item" href="<?php echo e(route('billing-list')); ?>">Billing List</a></li>
                                                <li><a class="dropdown-item" href="<?php echo e(route('create-invoice')); ?>">New Invoice</a></li>
                                            </ul>
                                        </li>
                                        <li><a href="<?php echo e(route('medical')); ?>">Medical</a></li>
                                        <li><a href="<?php echo e(route('doctor')); ?>">Doctor</a></li>
...
<footer>
    <!--? Footer Start-->
    <div class="footer-area section-bg" data-background="<?php echo e(asset('assets/img/gallery/footer_bg.jpg')); ?>">
        <div class="container">
                        ...
                        <div class="single-footer-caption mb-50">
                            <div class="footer-number mb-50">
                                ...
                                <ul class="footer-tittle">
                                   <h4><li><a href="<?php echo e(route('doctor')); ?>" class="text-gray-300 hover:text-white transition-colors">Doctor</a></li></h4>
                                   <h4><li><a href="<?php echo e(route('patients.index')); ?>" class="text-gray-300 hover:text-white transition-colors">Patient</a></li></h4>
                                    <h4><li><a href="<?php echo e(route('appointments.index')); ?>" class="text-gray-300 hover:text-white transition-colors">Appointment</a></li></h4>
                                    <h4><li><a href="<?php echo e(route('billing-list')); ?>" class="text-gray-300 hover:text-white transition-colors">Billing</a></li></h4>
                                    <h4><li><a href="<?php echo e(route('medical')); ?>" class="text-gray-300 hover:text-white transition-colors">Medical</a></li></h4>
                                    <h4><li><a href="<?php echo e(route('pharmacy')); ?>" class="text-gray-300 hover:text-white transition-colors">Pharmacy</a></li></h4>
                                </ul>
...
<?php /**PATH C:\xampp\htdocs\Project-Web-App-main\resources\views/master/layout.blade.php ENDPATH**/ ?>