                    ...
                    <div class="row align-items-center no-gutters">
                        <div class="col-lg-7">
                            ...
                            <div class="dept_info">
                                ...
                                <a href="<?php echo e(route('medical.view_more')); ?>" class="dep-btn">View Records<i class="ti-arrow-right"></i></a>
                            </div>
                        </div>
                        <div class="col-lg-5">
...
<?php echo $__env->make('master.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Project-Web-App-main\resources\views/medical.blade.php ENDPATH**/ ?>