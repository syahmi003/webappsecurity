        ...
        <div class="container">
            ...
            <form id="invoice-form" action="<?php echo e(route('invoices.store')); ?>" method="POST">
                ...
                <div class="text-center mt-4">
                    ...
                    <a href="<?php echo e(route('billing-list')); ?>" class="btn btn-danger action-btn">Cancel</a>
                </div>
            </form>
        </div>
    </div>
...
<?php echo $__env->make('master.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Project-Web-App-main\resources\views/create-invoice.blade.php ENDPATH**/ ?>